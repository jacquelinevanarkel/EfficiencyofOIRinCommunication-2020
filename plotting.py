...
# Plot the communicative success per lexicon size with lines for the chance levels & relative CS
CS_means_interactional = results_interactional.groupby(["Number of Referents","Ambiguity Level"])["Number of Turns"].mean()
CS_std_interactional = results_interactional.groupby(["Number of Referents","Ambiguity Level"])["Number of Turns"].apply(np.std)
print(CS_std_interactional)
...
CS_means = results.groupby(["Number of Referents", "Entropy Threshold"])["Communicative Success"].mean()
...
plt.title("Communicative Success for Different Entropy Thresholds and Lexicon Sizes")
plt.legend(title="Lexicon Size")

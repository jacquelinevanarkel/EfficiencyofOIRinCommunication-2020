...
# ----------------------------------------------------------------------------------------------------------------------
# Plot of th mean entropy difference over time in an interaction for the interactional agents for different lexicon sizes
...
results["Order of Reasoning"] = np.where((results["Reached Threshold Order"]==True) &
                                         (results["Order of Reasoning Listener"]==1), "2 Frugal",
                                         results["Order of Reasoning Listener"])
...
plt.hlines(y=[0.25, 0.1, 0.05, 0.25, 0.1, 0.05, 0.25, 0.1, 0.05],
           ...
           xmax=[-0.13, 0.13, 0.40, 0.87, 2.13, 2.40, 2.87, 3.13, 3.40],
           colors=["black", "black", "white", "black", "black", "white","black", "black", "white"])
